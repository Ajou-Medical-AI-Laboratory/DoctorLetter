...
export function Profile({ onBack, onMembership, onLogout, onInsights, onUpgrade, userTier }: ProfileProps) {
  ...
  const [disease, setDisease] = useState('유방암');
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="bg-blue-50 rounded-2xl p-6 border border-blue-200">
            ...
            <ul className="space-y-2 text-blue-800 text-sm">
              ...
              <li className="flex items-start gap-2">
                <span>•</span>
                <span><strong>멤버십 관리:</strong> 더 많은 기능을 이용하려면 Pro 또는 Max로 업그레이드하세요</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900">김경현</h2>
                <p className="text-gray-600">kkhyun@example.com</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between py-3 border-b border-gray-200">
                ...
                <span className="font-medium text-gray-900">25세</span>
              </div>
              <div className="flex justify-between py-3 border-b border-gray-200">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200">
            ...
            {editMode === 'password' ? (
              ...
              <p className="text-gray-600">마지막 변경: 2026년 3월 15일</p>
            )}
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200">
            ...
            {editMode === 'disease' ? (
              ...
              <p className="text-gray-900 text-lg font-medium">{disease}</p>
            )}
          </div>
